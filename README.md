...
4.数据链接：[ACELIU0852/DeepLearningAndCommonFactors](https://huggingface.co/datasets/ACELIU0852/DeepLearningAndCommonFactors)     （数据为Hong Kong Chu Hai College向CSMAR公司采购，请遵守相关相关版权限制）
